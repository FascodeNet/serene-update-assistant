...
Source0: https://github.com/FascodeNet/serene-update-assistant/archive/v0.0.0.6.tar.gz
%description
...
%setup -n serene-update-assistant-0.0.0.6
...
mkdir -p ${RPM_BUILD_ROOT}/usr/share/serene-update-assistant
...
lrelease-qt5  ../serene-update-assistant-gui_ja_JP.ts -qm ${RPM_BUILD_ROOT}/usr/share/serene-update-assistant/serene-update-assistant-gui_ja_JP.qm
...
/usr/share/serene-update-assistant/serene-update-assistant-gui_ja_JP.qm
